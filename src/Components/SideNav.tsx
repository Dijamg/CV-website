...
const StyledSideElement = ({ children, isVisible }: { children: React.ReactNode, isVisible: boolean }) => (
  <div className={`
    w-10 
    fixed 
    bottom-0 
...
const SideNav = () => {
  ...
  useEffect(() => {
    // Delay the appearance by 1 second after component mounts
  ...
  return (
    <div className="flex flex-col gap-4">
      <StyledSideElement isVisible={isVisible}>
        <StyledSocialList>
          {/* LinkedIn Icon */}
