	...
	return (
		<div className="min-h-screen bg-[#0A192F] text-white flex items-center justify-center">
			<div className="text-center relative">
				{/* Spinning circle - same style as TPX-remaster */}
				<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spin">
					<div className="w-96 h-96 rounded-full border-2 border-transparent border-t-purple-400 border-r-purple-400"></div>
				</div>
